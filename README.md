...
| [Day 3](./src/bin/03.rs) | `458.3µs` | `1.1ms` |
| [Day 4](./src/bin/04.rs) | `3.0ms` | `923.1µs` |
| [Day 5](./src/bin/05.rs) | `1.4ms` | `9.1ms` |
| [Day 6](./src/bin/06.rs) | `637.2µs` | `1.7s` |
| [Day 7](./src/bin/07.rs) | `3.3ms` | `744.2ms` |
| [Day 8](./src/bin/08.rs) | `47.3µs` | `100.1µs` |
